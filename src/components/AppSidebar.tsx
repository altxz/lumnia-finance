      ...
      <SidebarHeader className={collapsed ? 'p-2' : 'p-4'}>
        <div className="flex items-center justify-center gap-3">
          {collapsed ? (
            ...
            <>
              <img src="/brand-logo-black.svg" alt="Lumnia" className="h-10 w-auto shrink-0 dark:hidden" />
              <img src="/brand-logo-white.svg" alt="Lumnia" className="hidden h-10 w-auto shrink-0 dark:block" />
            </>
          )}
        </div>
      </SidebarHeader>
