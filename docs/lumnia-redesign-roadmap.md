...
- Etapa 8: concluída em 30/08/2026 (bottom sheets, carregamento escalonado, estado offline/retry). TypeScript, lint crítico, 97 testes e build web passaram; validado no navegador e fisicamente no Galaxy S22 Ultra (APK SHA-256 `37fa0a97...`, ver `docs/ai-memory/03-entrega-android-e-validacao.md`).
...
- Próximo checkpoint: auditoria final (Etapa 9). Publicar a conta do Google Play Console continua fora de escopo por decisão do usuário.
